...
use crate::tools::textfiles::{TextFile, file_exists};
...
impl Hammer{
    ...
    fn new_type(&mut self, name: String, size: u32){
        self.type_list.insert( name.clone(), Type{name, size, stars: 0});   
    }
...
pub fn instruct_loop(hammer: &mut Hammer) -> Result<(), String>{
